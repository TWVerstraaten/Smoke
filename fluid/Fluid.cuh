...
namespace app::fluid {
    ...
    class Fluid {
      ...
      private:
        ...
        // Pointers for CUDA
        float* m_density_gpu          = nullptr;
        float* m_density_previous_gpu = nullptr;
        float* m_u_gpu                = nullptr;
        float* m_v_gpu                = nullptr;
        float* m_u_previous_gpu       = nullptr;
        float* m_v_previous_gpu       = nullptr;
    };
} // namespace app::fluid
